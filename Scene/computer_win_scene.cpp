...
void Computer_Win_Scene::Initialize(){
    ...
    AddNewObject(new Engine::Label("<< 電腦勝利 >>", "font2.ttc", 150, halfW, 150, 223, 21, 21, 255, 0.5, 0.5));
    ...
    btn->SetOnClickCallback(std::bind(&Computer_Win_Scene::BackOnClick, this, 1));
...
void Computer_Win_Scene::Terminate(){
    AudioHelper::StopBGM(bgmId);
    IScene::Terminate();

}
void Computer_Win_Scene::BackOnClick(int stage){
